...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_form_invalid_renewal_date_past(self):
        ...
        self.assertEqual( resp.status_code,200)
        # ERROR DE TUTORIAL: assertFormError no funciona de la forma indicada.
        #self.assertFormError(resp, 'form', 'renewal_date', 'Fecha inválida - renovación en el pasado')
        # Obtener el formulario del contexto
        form = resp.context['form']
        
        # Imprimir los errores del formulario para depurar
        print(form.errors)
        
        # Verificar que el formulario tenga los errores esperados
        self.assertTrue(form.errors)
        self.assertIn('renewal_date', form.errors)
        self.assertIn('Fecha inválida - renovación en el pasado', form.errors['renewal_date'])
    ...
    def test_form_invalid_renewal_date_future(self):
        ...
        self.assertTrue(form.errors)
        self.assertIn('renewal_date', form.errors)
        self.assertIn('Fecha inválida - renovación con más de 4 semanas de antelación', form.errors['renewal_date'])
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_logged_in_with_permission_borrowed_book(self):
        ...
        #Comprobar que nos permita iniciar sesión: permite ver el formulario
        self.assertEqual( resp.status_code,200)
    ...
    def test_form_initial_date_of_death(self):
        ...
        defaultDate = '12/10/2016'
        self.assertEqual(resp.context['form'].initial['date_of_death'], defaultDate )